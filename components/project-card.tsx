      ...
      <article className="group h-full overflow-hidden rounded-[1.6rem] border border-white/10 bg-white/[0.045] p-6 shadow-[0_20px_50px_-35px_rgba(15,23,42,0.9)] transition-all duration-300 hover:-translate-y-1.5 hover:border-accent/25 hover:shadow-[0_26px_70px_-36px_rgba(79,209,255,0.16)]">
        <div className="flex h-full flex-col gap-6">
          <div className="space-y-4">
            <div className="min-h-28 space-y-2 border-b border-white/8 pb-4">
              <h3 className="min-h-14 text-xl font-semibold tracking-tight text-foreground">
                {project.title}
              </h3>
              <p className="min-h-12 text-sm leading-6 text-muted-foreground/95">
                {project.summary}
              </p>
            </div>
          ...
          <ul className="min-h-[4.5rem] content-start flex flex-wrap gap-2">
